...
class PolyEncoder(nn.Module):
    def __init__(self, model_name, poly_m=128):
        super().__init__()
...
class CreativityScorer(pl.LightningModule):
    def __init__(self, model_name, logger, poly_m=128, lr=1e-5):
        super().__init__()
        self.model_name = model_name
    ...
    def on_validation_epoch_end(self):
        ...
        correlation = computeCorrelation(self, "/home/sam/datasets/test.csv", 16, "microsoft/deberta-v3-large", 128)
